    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topping', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='topping_amounts', to='project.topping')),
            ],
        ),
        migrations.AddField(
            model_name='pizza',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('combo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='project.combo')),
                ('dishes', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='project.sidedishes')),
                ('pizza', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='project.pizza')),
            ],
        ),
        migrations.AddField(
            model_name='combo',

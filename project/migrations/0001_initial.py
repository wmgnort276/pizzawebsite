    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu', models.CharField(choices=[('Sang', 'Sang'), ('Trua', 'Trua'), ('Chieu', 'Chieu'), ('Toi', 'Toi'), ('Chay', 'Chay'), ('Treem', 'Treem')], default='Sang', max_length=8)),
            ],
            options={
                'ordering': ('name',),
            },
        ...
        migrations.AddField(
            model_name='combo',
            name='combocategory',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='category', to='project.combocategory'),
        ),
        migrations.AddField(
            model_name='combo',
            name='pizzas',
